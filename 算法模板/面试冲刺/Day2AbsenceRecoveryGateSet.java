...
public class Day2AbsenceRecoveryGateSet {
    ...
    // Fixed lowercase alphabet lets direct count cancellation beat sorting.
    ...
    // Only values without predecessors may start expansion.
    ...
    // Count earlier prefixes equal to currentPrefix - k before inserting currentPrefix.
    ...
    // The first repeated balance gives the widest valid interval.
    ...
    // Equal normalized modulo states imply a divisible subarray difference.
